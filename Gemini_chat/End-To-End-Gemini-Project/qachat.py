...
def get_grain_and_storage_facilities(location):
    ...
    question = f"Grain and farming storage facilities near {location} kilometre radius of me. Please return as json response the name, phone number and address"
...
def get_input_suppliers(location):
    ...
    question = f"Input suppliers of seeds and farming products near {location} kilometre radius of me. Please return as json response the name, phone number and address"
    return get_gemini_response(question)
...
def get_soil_testing_services(location):
    ...
    question = f"Soil testing services near {location} kilometre radius of me. Please return as json response the name, phone number and address"
    return get_gemini_response(question)
